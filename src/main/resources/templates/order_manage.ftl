...
<script type="text/javascript">
    ...
    function deleteOrder(ordercode,orderStatus) {
        xescm.common.ofcSubmit("/ofc/orderDelete","您确定要删除此订单?",{"orderCode":ordercode,"orderStatus":orderStatus},function () {
    ...
    function reviewOrder(ordercode,orderStatus) {
        xescm.common.ofcSubmit("/ofc/orderOrNotAudit","您确定要审核此订单?",{"orderCode":ordercode,"orderStatus":orderStatus,"reviewTag":"review"},function () {
            debugger;
            xescm.common.loadPage("/ofc/orderManage");
        });
    }
    function reReviewOrder(ordercode,orderStatus) {
        xescm.common.ofcSubmit("/ofc/orderOrNotAudit","您确定要反审核此订单?",{"orderCode":ordercode,"orderStatus":orderStatus,"reviewTag":"rereview"},function () {
            xescm.common.loadPage("/ofc/orderManage");
        });
    }
    function cancelOrder(ordercode,orderStatus) {
        xescm.common.ofcSubmit("/ofc/orderCancel","您确定要取消此订单?",{"orderCode":ordercode,"orderStatus":orderStatus},function () {
            xescm.common.loadPage("/ofc/orderManage");
        });
    }
