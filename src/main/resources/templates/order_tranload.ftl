                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="tabbable" style="width:1000px;" >
                                    <ul class="nav nav-tabs" id="myTab4">
                                        ...
                                        <li class="transLi">
                                            <a data-toggle="tab" href="#consignor14" aria-expanded="true">发货方1</a>
                                        </li>
                                        <li class="transLi">
                                    ...
                                    <div class="tab-content">
                                        <div id="home4" class="tab-pane active">
                                            ...
                                            <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                            <label class="control-label" style="float:right;" for="name">重量合计111：</label>
                                            <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
