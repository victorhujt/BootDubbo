  ...
  <div class="page-content no-padding-top">
      <div class="page-header" style="margin-top:10px;">
        ...
        <#--<#import "address.ftl" as apiAddrFtl>-->
          ...
          <input type="hidden" id="orderType" name="orderType" <#if orderInfo.orderType?? >value="${orderInfo.orderType}"</#if>">
        </p>
      </div>
      ...
      <form id="orderFundamentalFormValidate" method="post" class="form-horizontal" role="form" >
        <div class="form-group" id="transBusinessTypeDiv">
          <div><label class="control-label col-label no-padding-right" for="name" style="margin-right:8px;"><span class="w-label-icon">*</span>业务类型</label>
            <div class="col-width-168 padding-15">
              <div class="clearfix col-width-168">
                <select  id="businessType" name="businessType" class="chosen-select form-control " disabled="disabled">
                  <option value="602" <#if orderInfo.businessType?? ><#if ((orderInfo.businessType)! == '602')>selected="selected"</#if></#if>>卡班</option>
          ...
          <div><label class="control-label col-label no-padding-right" for="merchandiser"><span class="w-label-icon">*</span>开单员</label>
            <div class="col-width-168 padding-15" style="margin-left:3px;">
              <div class="col-width-168">
                <div class="clearfix">
                  <input id="merchandiser" name="merchandiser" class="col-width-168" value="${(orderInfo.merchandiser)!""}" disabled="disabled">
                </div>
              </div>
            </div></div>
          <div><label class="control-label col-label" for="name" style="margin-right:18px;margin-left:52px;"><span class="w-label-icon">*</span>运输类型</label>
            ...
            <div class="radio y-float">
              <label>
                <input id="transportTypeV1" type="radio" class="ace" name="transportTypeV" <#if orderInfo.transportType?? ><#if ((orderInfo.transportType)! == '10')>checked="checked"</#if></#if> value="10" disabled="disabled"/>
                <span class="lbl">零担</span>
              </label>
            </div>
            <div class="radio y-float">
              <label>
                <input id="transportTypeV2" type="radio" class="ace" name="transportTypeV" <#if orderInfo.transportType?? ><#if ((orderInfo.transportType)! == '20')>checked="checked"</#if></#if> value="20" disabled="disabled"/>
                <span class="lbl">整车</span>
              </label>
            </div>
            <input id="transportType" type="hidden" name="transportType" value="${(orderInfo.transportType)!""}"/></div>
        </div>
        <div class="form-group">
            ...
            <div class="col-width-168 padding-15">
              <div class="clearfix" >
                <div class="col-width-168 position-relative" style="height:34px;">
                  <input class="col-width-168 es-input" name="orderTime" id="orderTime" type="text" placeholder="订单日期" aria-controls="dynamic-table" readonly class="laydate-icon" id="startDate" <#if orderInfo.orderTime?? >value="${((orderInfo.orderTime)?string('yyyy-MM-dd'))!}"</#if> disabled="disabled">
          ...
          <div><label class="control-label col-label no-padding-right" for="transCode"><span class="w-label-icon toggle">*</span>运输单号</label>
            <div class="col-width-168 padding-15" style="margin-left:3px;">
              <div class="col-width-168">
                <input class="col-width-168"  name="transCode" id="transCode" type="text" placeholder="运输单号" style="padding-left:8px;" value="${(orderInfo.transCode)!""}" disabled="disabled"/>
              </div>
            </div></div>
          <div>
            ...
            <div class="col-width-168 padding-15" style="margin-left:3px;">
              <div class="col-width-168">
                <input class="col-width-168"  name="custOrderCode" id="custOrderCode" onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')" type="text" placeholder="客户订单号" style="padding-left:8px;"  value="${(orderInfo.custOrderCode)!""}" disabled="disabled"/>
              </div>
            </div>
          </div>
        </div>
        <div class="form-group">
          <div style="float:left;">
            ...
            <div class="col-xs-2">
              <div class="position-relative" style="width:433px;">
                <input readonly name="custName" id="custName" type="text" placeholder="客户名称" style="padding-left:8px;width:430px;" value="${(orderInfo.custName)!""}" disabled="disabled"/>
                <input class="col-xs-10 col-xs-12" name=""  id="custGroupId" type="text" style="display: none"  />
                <input class="col-xs-10 col-xs-12" name=""  id="customerCode" type="text"  style="display: none"  value="${(orderInfo.custCode)!""}" disabled="disabled"/>
                <button type="button" class="initBtn" id="custListDivBlock"style="outline:none;"  disabled="disabled">
          ...
          <div style="float:left;">
            ...
            <div class="col-width-168 padding-15">
              <div class="clearfix" >
                <div class="col-width-168 position-relative" style="height:34px;">
                  <input class="col-width-168 es-input" name="expectedArrivedTime" id="expectedArrivedTime" type="text" placeholder="承诺到达时间" aria-controls="dynamic-table" readonly class="laydate-icon" id="startDate" <#if orderInfo.expectedArrivedTime?? >value="${((orderInfo.expectedArrivedTime)?string('yyyy-MM-dd HH:mm:ss'))!}"</#if> disabled="disabled">
        ...
        <div class="form-group">
          <div><label class="control-label col-label no-padding-right" for="transRequire" style="margin-right:8px;">备注</label>
            <div class="col-xs-2">
              <div class="position-relative" style="width:433px;">
                <input name="transRequire" id="transRequire" type="text" placeholder="备注" style="padding-left:8px;width:433px;" value="${(orderInfo.notes)!""}" disabled="disabled"/>
      ...
      <form name="orderInfoTableValidate" id="orderInfoTableValidate"  class="form-horizontal" role="form" style="min-height:250px;">
        <div style="width:515px;margin-right:20px;float:left;">
            ...
            <div class="form-group" >
              ...
              <div class="col-width-376 padding-15">
                <div class="clearfix position-relative">
                  <input id="consignorCode" name="consignorCode" type="hidden" value="${(orderInfo.consignorCode)!""}" disabled="disabled">
                  <input id="consignorType" name="consignorType" type="hidden" value="${(orderInfo.consignorType)!""}" disabled="disabled">
                  <input id="consignorName"  name="consignorName" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.consignorName)!""}" disabled="disabled">
                  <!--<label id="consignorListDivBlock" class="initBtn" for="consignorName" disabled="disabled"><i class="fa fa-user bigger-130"></i></label>-->
                </div>
              </div>
            </div>
            <div class="form-group" >
              ...
              <div class="col-width-168 padding-15">
                <div class="clearfix">
                  <input id="consignorContactCode"   name="consignorContactCode" type="hidden" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.consignorContactCode)!""}" disabled="disabled">
                  <input id="consignorContactName"   name="consignorContactName" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.consignorContactName)!""}" disabled="disabled">
                </div>
              </div>
              ...
              <div class="col-width-168 padding-15">
                <div class="clearfix">
                  <input id="consignorPhone" name="consignorPhone" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.consignorContactPhone)!""}" disabled="disabled">
                </div>
              </div>
            </div>
           <#-- <div class="form-group" >
            ...
            <div class="form-group" >
              ...
              <div class="col-width-376 padding-15">
                <div class="clearfix">
                  <span style="cursor:pointer;position:relative;" id="city-picker-consignor"><input id="city-picker3-consignor" class="form-control input-sm" readonly type="text" data-toggle="city-picker" value="${(orderInfo.departureProvince)!""}/${(orderInfo.departureCity)!""}/${(orderInfo.departureDistrict)!""}/${(orderInfo.departureTowns)!""}"></span>
                </div>
              </div>
            </div>
            <div class="form-group" >
              ...
              <div class="col-width-376 padding-15">
                <div class="clearfix">
                  <input id="consignorAddress" name="consignorAddress" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.departurePlace)!""}" disabled="disabled">
                </div>
              </div>
            </div>
         <#-- <div class="form-group">
         ...
         <#-- <label id="destination" class="control-label" style="float:right;" for="name"></label>
          ...
          <div id="consignorout" style="margin-top:15px;">
            <div class="form-group" >
              ...
              <div class="col-width-376 padding-15">
                <div class="clearfix position-relative">
                  <input id="consigneeCode" name="consigneeCode" type="hidden" value="${(orderInfo.consigneeCode)!""}" disabled="disabled">
                  <input id="consigneeType" name="consigneeType" type="hidden" value="${(orderInfo.consigneeType)!""}" disabled="disabled">
                  <input id="consigneeName"  name="consigneeName" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.consigneeName)!""}" disabled="disabled">
                  <!--<label id="consigneeListDivBlock" class="initBtn" for="consignorName" disabled="disabled"><i class="fa fa-user bigger-130"></i></label>-->
                </div>
              </div>
            </div>
            <div class="form-group" >
              ...
              <div class="col-width-168 padding-15">
                <div class="clearfix">
                  <input id="consigneeContactCode" name="consigneeContactCode" type="hidden" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.consigneeContactCode)!""}" disabled="disabled">
                  <input id="consigneeContactName" name="consigneeContactName" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.consigneeContactName)!""}" disabled="disabled">
              ...
              <div class="col-width-168 padding-15">
                <div class="clearfix">
                  <input id="consigneePhone" name="consigneePhone" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.consigneeContactPhone)!""}" disabled="disabled">
          ...
          <#--  <div class="form-group" >
            ...
            <div class="form-group" >
              ...
              <div class="col-width-376 padding-15">
                <div class="clearfix">
                  <span style="cursor:pointer;position:relative;" id="city-picker-consignee"><input id="city-picker3-consignee" class="form-control input-sm" readonly type="text" data-toggle="city-picker" value="${(orderInfo.destinationProvince)!""}/${(orderInfo.destinationCity)!""}/${(orderInfo.destinationDistrict)!""}/${(orderInfo.destinationTowns)!""}"></span>
                </div>
              </div>
            </div>
            <div class="form-group" >
              ...
              <div class="col-width-376 padding-15">
                <div class="clearfix">
                  <input id="consigneeAddress" name="consigneeAddress" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${(orderInfo.destination)!""}" disabled="disabled">
                </div>
              </div>
            </div>
            <#--<div class="form-group">
              <label class="control-label col-label no-padding-right" for="name">目的地</label>
             &lt;#&ndash; <label id="destination" class="control-label" style="float:left;padding:0 15px;line-height:34px;" for="name"></label>&ndash;&gt;
              <div class="col-width-376 padding-15">
                <div class="clearfix">
      ...
      <form id="orderFinanceFormValidate" method="post" class="form-horizontal" role="form" >
        <div class="form-group">
          <div style="width:280px;margin:0 0 0 15px;float:left;">
            <div class="clearfix col-xs-1" style="margin-top:4px;">
              <input id="pickUpGoodsV" class="btn btn-minier btn-inverse no-padding-right" type="checkbox" name = "" <#if orderInfo.pickUpGoods?? ><#if ((orderInfo.pickUpGoods) == "1")> checked="checked"</#if></#if>  disabled="disabled"/>
              <input id="pickUpGoods" type="hidden" name="pickUpGoods"  value="${(orderInfo.pickUpGoods)!""}" />
            </div>
            ...
            <div style="width:140px;float:left;">
              <div class="col-width-100 margin-right-15">
                <input class="col-width-100" id="homeDeliveryFee" disabled="true" style="color: #000" name="homeDeliveryFee" type="text" class="form-control input-sm " placeholder="" aria-controls="dynamic-table" onblur= "countCostCheck()" value="${((orderInfo.homeDeliveryFee)!0)?c}"  disabled="disabled"/>
              </div>
        ...
        <div class="form-group">
          <div style="width:280px;margin:0 0 0 15px;float:left;">
            <div class="clearfix col-xs-1" style="margin-top:4px;">
              <input id="insureV" type="checkbox" name=""  class="btn btn-minier btn-inverse no-padding-right" <#if orderInfo.insure?? ><#if ((orderInfo.insure) == "1")> checked="checked"</#if></#if>  disabled="disabled"/>
              <input id="insure" type="hidden" name="insure"  value="${(orderInfo.insure)!""}"/>
            </div>
            <label class="control-label col-width-110" for="name" style="padding:0px 15px 0 10px;">货物保险:费用</label>
            <div style="width:140px;float:left;">
              <div  class="col-width-100 margin-right-15" >
                <input class="col-width-100"  id="cargoInsuranceFee" disabled="true" style="color: #000" name="cargoInsuranceFee" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countCostCheck()" value="${((orderInfo.cargoInsuranceFee)!0)?c}"  disabled="disabled">
              </div>
              <label class="control-label" for="name" style="height:34px;line-height:34px;">元</label>
            </div>
          </div>
          <div class="col-xs-6 no-padding-left">
            ...
            <div style="width:140px;float:left;">
              <div  class="col-width-100 margin-right-15">
                <input class="col-width-100" id="insureValue" disabled="true" style="color: #000" name="insureValue" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countCostCheck()" value="${((orderInfo.insureValue)!0)?c}"  disabled="disabled">
              </div>
              <label class="control-label" for="name" style="height:34px;line-height:34px;">元</label>
            </div>
          </div>
        ...
        <div class="form-group">
          <div style="width:280px;margin:0 0 0 15px;float:left;">
            <div class="clearfix col-xs-1" style="margin-top:4px;">
              <input id="twoDistributionV" type="checkbox" name=""  class="btn btn-minier btn-inverse no-padding-right" <#if orderInfo.twoDistribution?? ><#if ((orderInfo.twoDistribution) == "1")> checked="checked"</#if></#if>  disabled="disabled"/>
              <input id="twoDistribution" type="hidden" name="twoDistribution"  value="${(orderInfo.twoDistribution)!""}" />
            </div>
            <label class="control-label col-width-110" for="name" style="padding:0px 15px 0; 10px">二次配送:费用</label>
            <div style="width:140px;float:left;">
              <div  class="col-width-100 margin-right-15">
                <input class="col-width-100" id="twoDistributionFee" disabled="true" style="color: #000" name="twoDistributionFee" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countCostCheck()" value="${((orderInfo.twoDistributionFee)!0)?c}"  disabled="disabled">
              </div>
              <label class="control-label" for="name" style="height:34px;line-height:34px;">元</label>
            </div>
          </div>
        ...
        <div class="form-group">
          <div style="width:280px;margin:0 0 0 15px;float:left;">
            <div class="clearfix col-xs-1" style="margin-top:4px;">
              <input id="collectFlagV" type="checkbox" name=""  class="btn btn-minier btn-inverse no-padding-right" <#if orderInfo.collectFlag?? ><#if ((orderInfo.collectFlag) == "1")> checked="checked"</#if></#if>  disabled="disabled"/>
              <input id="collectFlag" type="hidden" name="collectFlag"  value="${(orderInfo.collectFlag)!""}"/>
            </div>
            <label class="control-label col-width-110" for="name" style="padding:0px 15px 0 10px;">代收货款:费用</label>
            <div style="width:140px;float:left;">
              <div  class="col-width-100 margin-right-15" >
                <input class="col-width-100" id="collectServiceCharge" disabled="true" style="color: #000" name="collectServiceCharge" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countCostCheck()" value="${((orderInfo.collectServiceCharge)!0)?c}"  disabled="disabled">
              </div>
              <label class="control-label" for="name" style="height:34px;line-height:34px;">元</label>
            </div>
          </div>
          <div class="col-xs-6 no-padding-left">
            ...
            <div style="width:140px;float:left;">
              <div  class="col-width-100 margin-right-15">
                <input class="col-width-100" id="collectLoanAmount" disabled="true" style="color: #FF0000;" name="collectLoanAmount" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countCostCheck()" value="${((orderInfo.collectLoanAmount)!0)?c}"  disabled="disabled">
              </div>
              <label class="control-label" for="name" style="height:34px;line-height:34px;">元</label>
            </div>
          </div>
        ...
        <div class="form-group">
          <div style="width:280px;margin:0 0 0 15px;float:left;">
            <div class="clearfix col-xs-1" style="margin-top:4px;">
              <input id="returnListV" type="checkbox" name=""  class="btn btn-minier btn-inverse no-padding-right" <#if orderInfo.returnList?? ><#if ((orderInfo.returnList) == "1")> checked="checked"</#if></#if>  disabled="disabled" />
              <input id="returnList" type="hidden" name="returnList"  value="${(orderInfo.returnList)!""}" />
            </div>
            <label class="control-label col-width-110" for="name" style="padding:0px 15px 0; 10px">签单返回:费用</label>
            <div style="width:140px;float:left;">
              <div  class="col-width-100 margin-right-15">
                <input class="col-width-100" id="returnListFee" disabled="true" style="color: #000" name="returnListFee" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countCostCheck()" value="${((orderInfo.returnListFee)!0)?c}"  disabled="disabled">
              </div>
              <label class="control-label" for="name" style="height:34px;line-height:34px;">元</label>
            </div>
          </div>
          <div class="col-xs-6 no-padding-left">
            ...
            <div style="width:140px;float:left;">
              <div  class="col-width-100 margin-right-15">
                <input class="col-width-100" id="luggage" style="color: #000" name="luggage" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countCostCheck()" value="${((orderInfo.luggage)!0)?c}"  disabled="disabled">
              </div>
              <label class="control-label" for="name" style="height:34px;line-height:34px;">元</label>
            </div>
          </div>
        ...
        <div class="form-group" id="transBusinessTypeDiv" style="line-height:34px;">
          <div style="width:242px;float:left;margin-left:45px;" >
            ...
            <div class="col-width-100 padding-15" style="width:130px">
              <input id="serviceCharge" disabled="true" style="color: #000;display:block;float:left;" name="serviceCharge" type="text" class="form-control input-sm" placeholder="" aria-controls="dynamic-table" value="${((orderInfo.serviceCharge)!0)?c}">
            </div>
          ...
          <div >
            ...
            <div class="col-width-70" style="margin-right:10px;float:left;height:34px;">
              <label class="clearfix">
                <input id="expensePayntPartyV1" type="radio" class="ace" name="expensePaymentPartyV" <#if orderInfo.expensePaymentParty?? ><#if ((orderInfo.expensePaymentParty)! == '10')>checked="checked"</#if></#if> disabled="disabled" value="10" style="margin:5px;float:left;margin-top:11px;padding-to"/>
          ...
          <div>
            <div class="col-width-70" style="float:left;height:34px;">
              <label class="clearfix">
                <input id="expensePaymentPartyV2" type="radio" class="ace" name="expensePaymentPartyV" <#if orderInfo.expensePaymentParty?? ><#if ((orderInfo.expensePaymentParty)! == '20')>checked="checked"</#if></#if> disabled="disabled" value="20" style="margin:5px;float:left;margin-top:11px;"/>
                <span class="lbl" style="float:left;margin-right:5px;">收货方</span>
              </label>
            </div>
          </div>
          <input id="expensePaymentParty" type="hidden" name="expensePaymentParty" value="${(orderInfo.expensePaymentParty)!""}"/>
          <div>
            ...
            <div class="col-width-168 padding-15">
              <div class="clearfix col-width-100 pay">
                <select class="chosen-select form-control" id="payment" name="payment" disabled="disabled">
                  <option value="6810"  <#if orderInfo.payment?? ><#if ((orderInfo.payment)! == '6810')>selected="selected"</#if></#if>>现金</option>
                  <option value="6820"  <#if orderInfo.payment?? ><#if ((orderInfo.payment)! == '6820')>selected="selected"</#if></#if>>POS刷卡</option>
                  <option value="6830"  <#if orderInfo.payment?? ><#if ((orderInfo.payment)! == '6830')>selected="selected"</#if></#if>>微信</option>
                  <option value="6840"  <#if orderInfo.payment?? ><#if ((orderInfo.payment)! == '6840')>selected="selected"</#if></#if>>支付宝</option>
                  <option value="6850"  <#if orderInfo.payment?? ><#if ((orderInfo.payment)! == '6850')>selected="selected"</#if></#if>>银行支付</option>
                  <option value="6860"  <#if orderInfo.payment?? ><#if ((orderInfo.payment)! == '6860')>selected="selected"</#if></#if>>账户结算</option>
                </select>
              </div>
            </div>
          </div>
          <div style="width:230px;margin:0 0 0 15px;float:left;">
            <div class="clearfix col-xs-1" style="margin-top:-6px;margin-left:5px;">
              <input id="openInvoicesV" type="checkbox" name="" class="btn btn-minier btn-inverse no-padding-right" onchange="" <#if orderInfo.openInvoices?? ><#if ((orderInfo.openInvoices) == "1")> checked="checked"</#if></#if>  disabled="disabled"/>
              <input id="openInvoices" type="hidden" name="openInvoices"  value="${(orderInfo.openInvoices)!""}" />
            </div>
        ...
        <div class="form-group" id="transBusinessTypeDiv" style="line-height:34px;">
          ...
          <div style="width:400px;">
            ...
            <div style="float:left;width:130px;">
              <div class="col-float" style="width:100px;margin-right:15px;">
                <input id="currentAmount"  style="color: #000" name="currentAmount" type="text" class="col-width-100 form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countSettlement()"  value="${((orderInfo.currentAmount)!0)?c}"  disabled="disabled">
              </div>
          ...
          <div >
            ...
            <div style="width:130px;float:left;">
              <div class="col-float" style="width:100px;margin-right:15px;">
                <input id="toPayAmount"  style="color: #000" name="toPayAmount" type="text" class="col-width-100 form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countSettlement()"  value="${((orderInfo.toPayAmount)!0)?c}"  disabled="disabled">
              </div>
          ...
          <div>
            ...
            <div style="width:130px;float:left;">
              <div class="col-float" style="width:100px;margin-right:15px;">
                <input id="returnAmount"  style="color: #000" name="returnAmount" type="text" class="col-float form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countSettlement()"  value="${((orderInfo.returnAmount)!0)?c}"  disabled="disabled">
              </div>
              <label class=" col-float" for="name">元</label>
            </div>
          </div>
          <div>
            ...
            <div style="width:130px;float:left;">
              <div class="col-float" style="width:100px;margin-right:15px;">
                <input id="monthlyAmount"  style="color: #000" name="monthlyAmount" type="text" class="col-float form-control input-sm" placeholder="" aria-controls="dynamic-table" onblur="countSettlement()"  value="${((orderInfo.monthlyAmount)!0)?c}"  disabled="disabled">
              </div>
              <label class=" col-float" for="name">元</label>
            </div>
          </div>
  ...
  <#-- <ul class="nav nav-tabs" id="myTab4">
    ...
    <div class="tab-content" style="border:none;padding-top:0;">
      <div id="home4" class="tab-pane active">
        ...
        <!--货品明细-->
        <button type="button" style="float:right;display: none" class="btn btn-white btn-info btn-bold btn-interval"
                id="addGoods" disabled="disabled"></button>
        <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <label class="control-label" style="float:right;" for="name">kg</label>
        <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <label id="weightCount" class="control-label" style="float:right;" for="name">${((orderInfo.weight)!0)?c}</label>
        <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <label class="control-label" style="float:right;" for="name">重量合计：</label>
        <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <label id="quantityCount" class="control-label" style="float:right;" for="name">${((orderInfo.quantity)!0)?c}</label>
        <label id="" class="control-label" style="float:right;" for="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        ...
        <#--货品明细-->
          ...
          <#--货品明细-->
            ...
            <tr role="row" class="odd" align="center">
              <td><a class='red' style='margin-top:5px;'></a></td>
              <td><select  id='goodsType' name='goodsType' class='chosen-select' style='width:100px;' onchange='goodsTypeParentChange(this)'  disabled="disabled">
                <option>${(goodsDetails.goodsType)!""}</option>
              </select></td>
              <td><select  id='goodsCategory' name='goodsCategory' class='chosen-select form-control' style='width:80px;'  disabled="disabled">
                <option>${(goodsDetails.goodsCategory)!""}</option>
              </select></td>
              <td><input class='col-xs-12'  name='goodsCode' id='goodsCode' type='text' style='min-width:60px;' value="${(goodsDetails.goodsCode)!""}" disabled="disabled"></td>
              <td><input class='col-xs-12'  name='goodsName' id='goodsName' type='text' style='min-width:60px;' value="${(goodsDetails.goodsName)!""}" disabled="disabled"></td>
              <td><input class='col-xs-12'  name='goodsSpec' id='goodsSpec' type='text' style='min-width:60px;' value="${(goodsDetails.goodsSpec)!""}" disabled="disabled"></td>
              <td><input class='col-xs-12'  name='unit' id='unit' type='text' style='min-width:60px;' value="${(goodsDetails.unit)!""}" disabled="disabled"></td>
              <td><select  id='pack' class='chosen-select form-control' name='pack' style='width:80px;' disabled="disabled">
                <option value='01' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '01')>selected="selected"</#if></#if>>纸箱</option>
                <option value='02' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '02')>selected="selected"</#if></#if>>木箱</option>
                <option value='03' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '03')>selected="selected"</#if></#if>>桶</option>
                <option value='04' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '04')>selected="selected"</#if></#if>>混包</option>
                <option value='05' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '05')>selected="selected"</#if></#if>>裸装</option>
                <option value='06' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '06')>selected="selected"</#if></#if>>编袋</option>
                <option value='07' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '07')>selected="selected"</#if></#if>>托盘</option>
                <option value='08' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '08')>selected="selected"</#if></#if>>木框架</option>
                <option value='09' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '09')>selected="selected"</#if></#if>>泡沫箱</option>
                <option value='10' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '10')>selected="selected"</#if></#if>>缠绕膜</option>
                <option value='11' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '11')>selected="selected"</#if></#if>>盘</option>
                <option value='12' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '12')>selected="selected"</#if></#if>>铁框</option>
                <option value='13' <#if goodsDetails.pack?? ><#if ((goodsDetails.pack)! == '13')>selected="selected"</#if></#if>>布袋</option>
              </select></td>
              <td><select  id='chargingWays' name='chargingWays' class='chosen-select form-control' style='width:75px;' onchange='chargingWaysChange(this)'  disabled="disabled">
                <option value='01' <#if goodsDetails.chargingWays?? ><#if ((goodsDetails.chargingWays)! == '01')>selected="selected"</#if></#if>>件数</option>
              ...
              <td><input class='col-xs-12'  name='chargingUnitPrice' id='chargingUnitPrice' type='text' style='min-width:60px;' value="${((goodsDetails.chargingUnitPrice)!0)?c}" disabled="disabled"></td>
              <td><input class='col-xs-12'  name='quantity' id='quantity' type='text' style='min-width:60px;' value="${((goodsDetails.quantity)!0)?c}" disabled="disabled"></td>
              ...
              <td><input class='col-xs-12'  name='weight' id='weight' type='text' style='min-width:60px;' value="${((goodsDetails.weight)!0)?c}" disabled="disabled"></td>
              <td><input class='col-xs-12'  name='cubage' id='cubage' type='text' style='min-width:60px;' value="${((goodsDetails.cubage)!0)?c}" disabled="disabled"></td>
            </tr>
            </#list>
          </tbody>
...
/*  $("#consigneeListDivBlock").click(function() {confirmRev();});*/
  ...
  //货品列表
 /* $("#goodCodeSel").click(function() {confirmGood();});*/
