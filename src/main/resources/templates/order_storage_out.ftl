...
<div id="app">
    <div class="list-mian-01">
        ...
        <el-dialog title="选择客户" v-model="customerDataInfo.chosenCus" size="small">
            ...
            <el-table border :data="customerDataInfo.customerData" highlight-current-row @current-change="handleCurrentChange"
        ...
        <el-form :model="orderForm" :rules="rules" ref="orderForm" label-width="100px" class="demo-ruleForm">
            ...
            <div class="xe-block">
                ...
                <el-form-item label="联系人" required prop="consigneeContactName" class="xe-col-3">
            ...
            <div class="xe-block">
                <el-form-item label="联系电话" required prop="consigneeContactPhone" class="xe-col-3">
