...
public class TransportDTO {
   ...
   // private List<TransportDetailDTO> productDetail = new ArrayList<TransportDetailDTO>();
    ...
    public void setFromTransportName(String fromTransportName) {
        this.fromTransportName = fromTransportName;
    }
    ...
    public void setFromCustomerAddress(String fromCustomerAddress) {
        this.fromCustomerAddress = fromCustomerAddress;
    }
    ...
    public void setFromCustomerTle(String fromCustomerTle) {
        this.fromCustomerTle = fromCustomerTle;
    }
    ...
    public void setToCustomerAddress(String toCustomerAddress) {
        this.toCustomerAddress = toCustomerAddress;
    }
    ...
    public void setToCustomerTle(String toCustomerTle) {
        this.toCustomerTle = toCustomerTle;
    }
    ...
    public List<TransportDetailDTO> getProductDetail() {
