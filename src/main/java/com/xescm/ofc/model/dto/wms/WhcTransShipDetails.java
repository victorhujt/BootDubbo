...
@ApiModel(description = "调拨出库单详细信息实体类")
public class WhcTransShipDetails {
    private String id;
    ...
    @ApiModelProperty(notes = "货品重量")
    private BigDecimal itemWeight;

    @ApiModelProperty(notes = "货品体积")
    ...
    public WhcTransShip getOrder() {
        return order;
    }

    public void setOrder(WhcTransShip order) {
        this.order = order;
    }
